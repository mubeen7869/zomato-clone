...
function Home() {
    ...
    let getRestaurantListByLocId = async() =>{
        let url="http://localhost:3040/api//get-restaurant-list-by-loc-id/"+
    ...
    <>
        <section className="row main-section align-content-start">
            ...
            <section className="col-12 d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="search w-50 gap-lg-3 d-flex align-items-start mt-3">
                    <div className="w-50 position-relative mb-3 ">
                        ...
                        {hideLocation ? null : (
                            ...
                            {locations.map((location,index)=>{
                                    return (<li key={location._id} className="list-group-item" 
                    ...
                    <div className="w-100 input-group">
                        ...
                        <input
                            ...
                            {restaurant_list.list.map((restaurant,index)=>{
                                    return (<li key={restaurant._id} className="list-group-item" 
                                    onClick={()=> 
                            ...
                            return (
                                <section
                                    ...
                                    <div className="pt-3 px-2">
                                        ...
                                        <p className="small text-muted">{meal.content}
                                        </p>
                                    </div>
                                </section>
                            );
