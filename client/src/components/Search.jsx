              ...
              <div>
                <div className="ms-1">
                  <input type="radio" className="form-check-input" value={1}
                   onChange={(event)=> setFilterData(event,"cost")} />
                  <label htmlFor="" className="form-check-label ms-1">
                    less then 500
                  </label>
                </div>
                ...
                <div className="ms-1">
                  <input type="radio" className="form-check-input" value={3}
                  onChange={(event)=> setFilterData(event,"cost")}  />
                  <label htmlFor="" className="form-check-label ms-1">
                    1000 to 1500
                  </label>
                ...
                <div className="ms-1">
                  <input type="radio" className="form-check-input" value={4}
                  onChange={(event)=> setFilterData(event,"cost")}  />
                  <label htmlFor="" className="form-check-label ms-1">
                    1500 to 2000
                  </label>
                ...
                <div className="ms-1">
                  <input type="radio" className="form-check-input" value={5}
                  onChange={(event)=> setFilterData(event,"cost")}   />
                  <label htmlFor="" className="form-check-label ms-1">
                    2000+
                  </label>
              ...
              <div>
                <div className="ms-1">
                  <input type="radio" className="form-check-input"
                    value={1} onClick={(event) => setFilterData(event, 'sort')}
                    name="sort" />
                  <label htmlFor="" className="form-check-label ms-1">
                    Price low to high
                  </label>
          ...
          .map((page,i) => {
            return (
              <button
                ...
                onClick={(event) => setFilterData(event, "page")}
                value={i + 1}
                key={i}
              >
                {i + 1}
